...
See [BENCHMARK_H200.md](BENCHMARK_H200.md) tested with CUDA 13.0 for detailed results.
...
- **KDA Prefill (Hopper):** **avg 2.54x** speedup across fixed-length and variable-length sequences.
