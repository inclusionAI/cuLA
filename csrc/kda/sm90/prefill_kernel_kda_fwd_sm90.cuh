...
launch_kda_fwd_prefill_kernel_gbai(
    ...
    if constexpr (HopperSupported) {
        ...
        int32_t value_tok_stride = num_v_heads * head_size;
        ...
        Arguments arguments{
            ...
            .mainloop =
                ...
                .ptr_V = (T*)v,      .dV = {value_tok_stride, _1{}, head_stride},
                .ptr_O = (T*)output, .dO = {value_tok_stride, _1{}, head_stride},
                .ptr_Alpha = alpha,  .dAlpha = {value_tok_stride, _1{}, head_stride},
