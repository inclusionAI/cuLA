...
{
  static_assert(M == 64 || M == 128, "SM100_MMA_TF32_TS_MASK02 M-mode size should be 64 or 128 for 1 CTA cluster MMA.");
...
#else
    CUTE_INVALID_CONTROL_PATH("Attempting to use SM100_MMA_TF32_TS_MASK02 without CUTE_ARCH_TCGEN05_TF32_MMA_ENABLED");
#endif
    }
};
...
{
  static_assert(M == 64 || M == 128, "SM100_MMA_TF32_TS_MASK13 M-mode size should be 64 or 128 for 1 CTA cluster MMA.");
  static_assert((M == 64  && (N % 8 == 0)  && (8 <= N)  && (N <= 256)) ||
                (M == 128 && (N % 16 == 0) && (16 <= N) && (N <= 256)),
...
#else
    CUTE_INVALID_CONTROL_PATH("Attempting to use SM100_MMA_TF32_TS_MASK13 without CUTE_ARCH_TCGEN05_TF32_MMA_ENABLED");
#endif
    }
};
...
template <class a_type, class b_type, class c_type,
          ...
          UMMA::Saturate c_sat>
struct MMA_Traits<SM100_MMA_TF32_TS_MASK02<a_type, b_type, c_type,
                                M, N, a_major, b_major,
                                a_neg, b_neg, c_sat>>
{
  ...
  static_assert(cute::sizeof_bits_v<a_type> == cute::sizeof_bits_v<b_type> && cute::sizeof_bits_v<b_type> == 32, "SM100_MMA_TF32_TS_MASK02 supports 32bit types");
             ...
             Tensor<TC, CLayout> const& C)
  {
    ...
    SM100_MMA_TF32_TS_MASK02<a_type, b_type, c_type,
                   M, N, a_major, b_major,
...
template <class a_type, class b_type, class c_type,
          ...
          UMMA::ScaleIn a_neg, UMMA::ScaleIn b_neg,
          UMMA::Saturate c_sat>
struct MMA_Traits<SM100_MMA_TF32_TS_MASK13<a_type, b_type, c_type,
                                M, N, a_major, b_major,
                                a_neg, b_neg, c_sat>>
{
  using ValTypeD = c_type;
  ...
  using ValTypeB = b_type;
  using ValTypeC = c_type;
  static_assert(cute::sizeof_bits_v<a_type> == cute::sizeof_bits_v<b_type> && cute::sizeof_bits_v<b_type> == 32, "SM100_MMA_TF32_TS_MASK13 supports 32bit types");
             ...
             Tensor<TC, CLayout> const& C)
  {
    ...
    SM100_MMA_TF32_TS_MASK13<a_type, b_type, c_type,
                   M, N, a_major, b_major,
                   a_neg, b_neg, c_sat>::fma(desc_a, desc_b, tmem_c, uint32_t(traits.accumulate_), idesc);
  }
};
