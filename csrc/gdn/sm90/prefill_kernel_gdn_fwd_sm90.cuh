...
#include "gdn/sm90/device/device_universal.hpp"
#include "gdn/sm90/kernel/builder_gdn_fwd.hpp"
...
template <
    ...
    typename TState>
void
launch_gdn_fwd_prefill_kernel_gbai(
    cudaStream_t stream,
    TO* output,
    TState* output_state,
    TQKV const* q,
    ...
    if constexpr (HopperSupported) {
        ...
        using namespace gdn::sm90::kernel;
        ...
        using Operation = cutlass::device::Universal<typename gdn::sm90::kernel::FlatBuilderGdnFwd<
            T,
            float,
            float,
            TileShape,
        ...
        Arguments arguments{
            ...
            .mainloop =
                ...
                .ptr_Alpha = alpha,  .alpha_stride = {num_heads, _1{}},
