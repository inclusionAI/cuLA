...
# SM90 does not have cuLA delta-H/fwd-O kernels here; keep the FLA Triton
# adapters in the KDA dispatch layer instead of exposing them as cula.ops files.
...
def _get_fwd_kernels(device: torch.device):
    return _get_fwd_kernels_for_sm(*_get_device_sm_version(device))
