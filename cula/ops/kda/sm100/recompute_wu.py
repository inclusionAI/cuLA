...
class KDARecomputeWU:
    ...
    def __call__(
        ...
        class SharedStorage:
            ...
            load_kg_mbar: cute.struct.MemRange[Int64, self.kgk_stage * 2]
    ...
    def kernel(
        ...
        # =====================================================================
            ...
            if local_tidx < self.BT:
                if cutlass.const_expr(self.is_varlen):
                    sBeta[local_tidx] = cutlass.select_(local_tidx < remaining, beta_gmem[local_tidx], self.beta_dtype(0.0))
                else:
        ...
        # =====================================================================
            ...
            for i_kv in cutlass.range(0, self.NK):
                ...
                w_h = acc_done_C.wait_and_advance()
                cute.copy(tiled_t2r, tTR_tAcc[(None, None, None, w_h.index)], r_acc)
                ...
                u_h = acc_done_C.wait_and_advance()
                cute.copy(tiled_t2r, tTR_tAcc[(None, None, None, u_h.index)], r_acc)
                cute.arch.fence_view_async_tmem_load()
                u_h.release()
